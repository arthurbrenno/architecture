...
```python
import asyncio
from overture.logging import logger
from overture import BaseModel
from overture.services import Service, ServiceExecutor
from overture.data.repositories import Repository, CreateResult, ReadResult, ReadAllResult, UpdateResult, DeleteResult
...
```python
from overture.services import Service
...
```python
from overture.utils.decorators import pure
...
2. **Update Model Definitions:**
   ...
   Change your model classes to inherit from Overture's `BaseModel`.
